...
public class ItemCore {
	...
	public static final String NAME_RAW_GOLDAPPLE_PIE_HALL = "raw_piehallgldapple";
	...
	public static enum EnumIceFlavor{
		ICE_VANILA    (0,     "vanila",                       new EffectInstance[] {}, new ItemStack[]{ItemStack.EMPTY},ItemCore.item_ice_mix_vanila,ItemCore.item_icecream_vanila,ItemCore.item_icecream_cookie_vanila,new ResourceLocation("drf:textures/entity/icecream_vanila.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_vanila.png")),
		ICE_BLACK     (1,     DyeColor.BLACK.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.BLACK_DYE,1)},ItemCore.item_ice_mix_black,ItemCore.item_icecream_black,ItemCore.item_icecream_cookie_black,new ResourceLocation("drf:textures/entity/icecream_black.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_black.png")),
		ICE_RED       (2,     DyeColor.RED.toString(),        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.RED_DYE,1)},ItemCore.item_ice_mix_red,ItemCore.item_icecream_red,ItemCore.item_icecream_cookie_red,new ResourceLocation("drf:textures/entity/icecream_red.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_red.png")),
		ICE_GREEN     (3,     DyeColor.GREEN.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.GREEN_DYE,1)},ItemCore.item_ice_mix_green,ItemCore.item_icecream_green,ItemCore.item_icecream_cookie_green,new ResourceLocation("drf:textures/entity/icecream_green.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_green.png")),
		ICE_BROWN     (4,     DyeColor.BROWN.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.BROWN_DYE,1)},ItemCore.item_ice_mix_brown,ItemCore.item_icecream_brown,ItemCore.item_icecream_cookie_brown,new ResourceLocation("drf:textures/entity/icecream_brown.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_brown.png")),
		ICE_BLUE      (5,     DyeColor.BLUE.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.BLUE_DYE,1)},ItemCore.item_ice_mix_blue,ItemCore.item_icecream_blue,ItemCore.item_icecream_cookie_blue,new ResourceLocation("drf:textures/entity/icecream_blue.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_blue.png")),
		ICE_PURPLE    (6,     DyeColor.PURPLE.toString(),     new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.PURPLE_DYE,1)},ItemCore.item_ice_mix_purple,ItemCore.item_icecream_purple,ItemCore.item_icecream_cookie_purple,new ResourceLocation("drf:textures/entity/icecream_purple.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_purple.png")),
		ICE_CYAN      (7,     DyeColor.CYAN.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.CYAN_DYE,1)},ItemCore.item_ice_mix_cyan,ItemCore.item_icecream_cyan,ItemCore.item_icecream_cookie_cyan,new ResourceLocation("drf:textures/entity/icecream_cyan.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_cyan.png")),
		ICE_SILVER    (8,     DyeColor.LIGHT_GRAY.toString(), new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.LIGHT_GRAY_DYE,1)},ItemCore.item_ice_mix_silver,ItemCore.item_icecream_silver,ItemCore.item_icecream_cookie_silver,new ResourceLocation("drf:textures/entity/icecream_silver.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_silver.png")),
		ICE_GRAY      (9,     DyeColor.GRAY.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.GRAY_DYE,1)},ItemCore.item_ice_mix_gray,ItemCore.item_icecream_gray,ItemCore.item_icecream_cookie_gray,new ResourceLocation("drf:textures/entity/icecream_gray.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_gray.png")),
		ICE_PINK      (10,    DyeColor.PINK.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.PINK_DYE,1)},ItemCore.item_ice_mix_pink,ItemCore.item_icecream_pink,ItemCore.item_icecream_cookie_pink,new ResourceLocation("drf:textures/entity/icecream_pink.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_pink.png")),
		ICE_LIME      (11,    DyeColor.LIME.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.LIME_DYE,1)},ItemCore.item_ice_mix_lime,ItemCore.item_icecream_lime,ItemCore.item_icecream_cookie_lime,new ResourceLocation("drf:textures/entity/icecream_lime.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_lime.png")),
		ICE_YELLOW    (12,    DyeColor.YELLOW.toString(),     new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.YELLOW_DYE,1)},ItemCore.item_ice_mix_yellow,ItemCore.item_icecream_yellow,ItemCore.item_icecream_cookie_yellow,new ResourceLocation("drf:textures/entity/icecream_yellow.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_yellow.png")),
		ICE_LIGHT_BLUE(13,    DyeColor.LIGHT_BLUE.toString(), new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.LIGHT_BLUE_DYE,1)},ItemCore.item_ice_mix_light_blue,ItemCore.item_icecream_light_blue,ItemCore.item_icecream_cookie_light_blue,new ResourceLocation("drf:textures/entity/icecream_light_blue.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_light_blue.png")),
		ICE_MAGENTA   (14,    DyeColor.MAGENTA.toString(),    new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.MAGENTA_DYE,1)},ItemCore.item_ice_mix_magenta,ItemCore.item_icecream_magenta,ItemCore.item_icecream_cookie_magenta,new ResourceLocation("drf:textures/entity/icecream_magenta.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_magenta.png")),
		ICE_ORANGE    (15,    DyeColor.ORANGE.toString(),     new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.ORANGE_DYE,1)},ItemCore.item_ice_mix_orange,ItemCore.item_icecream_orange,ItemCore.item_icecream_cookie_orange,new ResourceLocation("drf:textures/entity/icecream_orange.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_orange.png")),
		ICE_WHITE     (16,    DyeColor.WHITE.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.WHITE_DYE,1)},ItemCore.item_ice_mix_white,ItemCore.item_icecream_white,ItemCore.item_icecream_cookie_white,new ResourceLocation("drf:textures/entity/icecream_white.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_white.png")),
		ICE_APPLE     (17,    "apple",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.APPLE,1)},ItemCore.item_ice_mix_apple,ItemCore.item_icecream_apple,ItemCore.item_icecream_cookie_apple,new ResourceLocation("drf:textures/entity/icecream_apple.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_apple.png")),
		ICE_CACTUS    (18,    "cactus",                       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Blocks.CACTUS,1)},ItemCore.item_ice_mix_cactus,ItemCore.item_icecream_cactus,ItemCore.item_icecream_cookie_cactus,new ResourceLocation("drf:textures/entity/icecream_cactus.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_cactus.png")),
		ICE_PUMPKIN   (19,    "pumpkin",                      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Blocks.PUMPKIN,1)},ItemCore.item_ice_mix_pumpkin,ItemCore.item_icecream_pumpkin,ItemCore.item_icecream_cookie_pumpkin,new ResourceLocation("drf:textures/entity/icecream_pumpkin.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_pumpkin.png")),
		ICE_POTATO    (20,    "potato",                       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.POTATO,1)},ItemCore.item_ice_mix_potato,ItemCore.item_icecream_potato,ItemCore.item_icecream_cookie_potato,new ResourceLocation("drf:textures/entity/icecream_potato.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_potato.png")),
		ICE_CARROT    (21,    "carrot",                       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.CARROT,1)},ItemCore.item_ice_mix_carrot,ItemCore.item_icecream_carrot,ItemCore.item_icecream_cookie_carrot,new ResourceLocation("drf:textures/entity/icecream_callot.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_callot.png")),
		ICE_MELON     (22,    "melon",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.MELON_SLICE,1), new ItemStack(Blocks.MELON,1)},ItemCore.item_ice_mix_melon,ItemCore.item_icecream_melon,ItemCore.item_icecream_cookie_melon,new ResourceLocation("drf:textures/entity/icecream_mellon.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_mellon.png")),
		ICE_GREENTEA  (23,    "greentea",                     new EffectInstance[] {}, new ItemStack[]{new ItemStack(ItemCore.item_greendust,1)},ItemCore.item_ice_mix_greentea,ItemCore.item_icecream_greentea,ItemCore.item_icecream_cookie_greentea,new ResourceLocation("drf:textures/entity/icecream_greentea.png"),new ResourceLocation("drf:textures/entity/icecream_cookie_greentea.png")),
		ICE_INK_SAC   (24,    "ink_sac",                      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.INK_SAC,1)},ItemCore.item_ice_mix_ink_sac,ItemCore.item_icecream_ink_sac,ItemCore.item_icecream_cookie_ink_sac,new ResourceLocation("drf.textures/entity/icecream_ink_sac.png"),new ResourceLocation("drf.textures/entity/icecream_cookie_ink_sac.png")),
		ICE_COCOA     (25,    "cocoa",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.COCOA_BEANS,1)},ItemCore.item_ice_mix_cocoa,ItemCore.item_icecream_cocoa,ItemCore.item_icecream_cookie_cocoa,new ResourceLocation("drf.textures/entity/icecream_cocoa.png"),new ResourceLocation("drf.textures/entity/icecream_cookie_cocoa.png")),
		ICE_BERRY     (26,    "berry",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.SWEET_BERRIES,1)},ItemCore.item_ice_mix_berry,ItemCore.item_icecream_berry,ItemCore.item_icecream_cookie_berry,new ResourceLocation("drf.textures/entity/icecream_berry.png"),new ResourceLocation("drf.textures/entity/icecream_cookie_berry.png")),
		ICE_KELP      (27,    "kelp",                         new EffectInstance[] {new EffectInstance(Effects.WATER_BREATHING, 1200, 1)}, new ItemStack[]{new ItemStack(ItemCore.item_kelpdust,1)},ItemCore.item_ice_mix_kelp,ItemCore.item_icecream_kelp,ItemCore.item_icecream_cookie_kelp,new ResourceLocation("drf.textures/entity/icecream_kelp.png"),new ResourceLocation("drf.textures/entity/icecream_cookie_kelp.png")),
		ICE_GOLDAPPLE (28,    "goldapple",                    new EffectInstance[] {new EffectInstance(Effects.REGENERATION, 100, 1), new EffectInstance(Effects.ABSORPTION, 2400, 0)}, new ItemStack[]{new ItemStack(Items.GOLDEN_APPLE,1)},ItemCore.item_ice_mix_goldapple,ItemCore.item_icecream_goldapple,ItemCore.item_icecream_cookie_goldapple,new ResourceLocation("drf.textures/entity/icecream_goldapple.png"),new ResourceLocation("drf.textures/entity/icecream_cookie_goldapple.png")),
		ICE_GOLDAPPLEENC (29, "goldappleenc",                 new EffectInstance[] {new EffectInstance(Effects.REGENERATION, 400, 1), new EffectInstance(Effects.RESISTANCE, 6000, 0), new EffectInstance(Effects.FIRE_RESISTANCE, 6000, 0), new EffectInstance(Effects.ABSORPTION, 2400, 3)}, new ItemStack[]{new ItemStack(Items.ENCHANTED_GOLDEN_APPLE,1)},ItemCore.item_ice_mix_goldappleenc,ItemCore.item_icecream_goldappleenc,ItemCore.item_icecream_cookie_goldappleenc,new ResourceLocation("drf.textures/entity/icecream_goldappleenc.png"),new ResourceLocation("drf.textures/entity/icecream_cookie_goldappleenc.png"));
		private int index;
		private int damage;
		...
		private Item icecookie;
		private ResourceLocation iceTexture;
		private ResourceLocation icecookieTexture;

		private EnumIceFlavor(int idx, String name, EffectInstance[] effect, ItemStack[] item, Item item1, Item item2, Item item3, ResourceLocation tex1, ResourceLocation tex2){
			index = idx;
			damage = idx;
			fravor = name;
			effects = effect;
		...
		public Item getIcemix(){return icemix;}
		public Item getIcecream(){return icecream;}
		public Item getIceCookie(){return icecookie;}
	...
	public static enum EnumFlapeSyrup{
		SYRUP_NONE      (0,     "none",                         new EffectInstance[] {}, new ItemStack[]{}, null, ItemCore.item_crashedice_none,ItemCore.item_crashedice_milk_none,ItemCore.item_sugar_water_none,ItemCore.item_icecandy_none,new ResourceLocation("drf:textures/entity/crashedice_none.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_none.png")),
		SYRUP_SUGAR     (1,     "sugar",                        new EffectInstance[] {}, new ItemStack[]{},ItemCore.item_syrup_sugar,ItemCore.item_crashedice_sugar,ItemCore.item_crashedice_milk_sugar,ItemCore.item_sugar_water_sugar,ItemCore.item_icecandy_sugar,new ResourceLocation("drf:textures/entity/crashedice_sugar.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_sugar.png")),
		SYRUP_BLACK     (2,     DyeColor.BLACK.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.BLACK_DYE,1)},ItemCore.item_syrup_black,ItemCore.item_crashedice_black,ItemCore.item_crashedice_milk_black,ItemCore.item_sugar_water_black,ItemCore.item_icecandy_black,new ResourceLocation("drf:textures/entity/crashedice_black.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_black.png")),
		SYRUP_RED       (3,     DyeColor.RED.toString(),        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.RED_DYE,1)},ItemCore.item_syrup_red,ItemCore.item_crashedice_red,ItemCore.item_crashedice_milk_red,ItemCore.item_sugar_water_red,ItemCore.item_icecandy_red,new ResourceLocation("drf:textures/entity/crashedice_red.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_red.png")),
		SYRUP_GREEN     (4,     DyeColor.GREEN.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.GREEN_DYE,1)},ItemCore.item_syrup_green,ItemCore.item_crashedice_green,ItemCore.item_crashedice_milk_green,ItemCore.item_sugar_water_green,ItemCore.item_icecandy_green,new ResourceLocation("drf:textures/entity/crashedice_green.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_green.png")),
		SYRUP_BROWN     (5,     DyeColor.BROWN.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.BROWN_DYE,1)},ItemCore.item_syrup_brown,ItemCore.item_crashedice_brown,ItemCore.item_crashedice_milk_brown,ItemCore.item_sugar_water_brown,ItemCore.item_icecandy_brown,new ResourceLocation("drf:textures/entity/crashedice_brown.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_brown.png")),
		SYRUP_BLUE      (6,     DyeColor.BLUE.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.BLUE_DYE,1)},ItemCore.item_syrup_blue,ItemCore.item_crashedice_blue,ItemCore.item_crashedice_milk_blue,ItemCore.item_sugar_water_blue,ItemCore.item_icecandy_blue,new ResourceLocation("drf:textures/entity/crashedice_blue.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_blue.png")),
		SYRUP_PURPLE    (7,     DyeColor.PURPLE.toString(),     new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.PURPLE_DYE,1)},ItemCore.item_syrup_purple,ItemCore.item_crashedice_purple,ItemCore.item_crashedice_milk_purple,ItemCore.item_sugar_water_purple,ItemCore.item_icecandy_purple,new ResourceLocation("drf:textures/entity/crashedice_purple.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_purple.png")),
		SYRUP_CYAN      (8,     DyeColor.CYAN.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.CYAN_DYE,1)},ItemCore.item_syrup_cyan,ItemCore.item_crashedice_cyan,ItemCore.item_crashedice_milk_cyan,ItemCore.item_sugar_water_cyan,ItemCore.item_icecandy_cyan,new ResourceLocation("drf:textures/entity/crashedice_cyan.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_cyan.png")),
		SYRUP_SILVER    (9,     DyeColor.LIGHT_GRAY.toString(), new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.LIGHT_GRAY_DYE,1)},ItemCore.item_syrup_silver,ItemCore.item_crashedice_silver,ItemCore.item_crashedice_milk_silver,ItemCore.item_sugar_water_silver,ItemCore.item_icecandy_silver,new ResourceLocation("drf:textures/entity/crashedice_silver.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_silver.png")),
		SYRUP_GRAY      (10,    DyeColor.GRAY.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.GRAY_DYE,1)},ItemCore.item_syrup_gray,ItemCore.item_crashedice_gray,ItemCore.item_crashedice_milk_gray,ItemCore.item_sugar_water_gray,ItemCore.item_icecandy_gray,new ResourceLocation("drf:textures/entity/crashedice_gray.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_gray.png")),
		SYRUP_PINK      (11,    DyeColor.PINK.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.PINK_DYE,1)},ItemCore.item_syrup_pink,ItemCore.item_crashedice_pink,ItemCore.item_crashedice_milk_pink,ItemCore.item_sugar_water_pink,ItemCore.item_icecandy_pink,new ResourceLocation("drf:textures/entity/crashedice_pink.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_pink.png")),
		SYRUP_LIME      (12,    DyeColor.LIME.toString(),       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.LIME_DYE,1)},ItemCore.item_syrup_lime,ItemCore.item_crashedice_lime,ItemCore.item_crashedice_milk_lime,ItemCore.item_sugar_water_lime,ItemCore.item_icecandy_lime,new ResourceLocation("drf:textures/entity/crashedice_lime.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_lime.png")),
		SYRUP_YELLOW    (13,    DyeColor.YELLOW.toString(),     new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.ORANGE_DYE,1)},ItemCore.item_syrup_yellow,ItemCore.item_crashedice_yellow,ItemCore.item_crashedice_milk_yellow,ItemCore.item_sugar_water_yellow,ItemCore.item_icecandy_yellow,new ResourceLocation("drf:textures/entity/crashedice_yellow.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_yellow.png")),
		SYRUP_LIGHT_BLUE(14,    DyeColor.LIGHT_BLUE.toString(), new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.LIGHT_BLUE_DYE,1)},ItemCore.item_syrup_light_blue,ItemCore.item_crashedice_light_blue,ItemCore.item_crashedice_milk_light_blue,ItemCore.item_sugar_water_light_blue,ItemCore.item_icecandy_light_blue,new ResourceLocation("drf:textures/entity/crashedice_light_blue.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_light_blue.png")),
		SYRUP_MAGENTA   (15,    DyeColor.MAGENTA.toString(),    new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.MAGENTA_DYE,1)},ItemCore.item_syrup_magenta,ItemCore.item_crashedice_magenta,ItemCore.item_crashedice_milk_magenta,ItemCore.item_sugar_water_magenta,ItemCore.item_icecandy_magenta,new ResourceLocation("drf:textures/entity/crashedice_magenta.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_magenta.png")),
		SYRUP_ORANGE    (16,    DyeColor.ORANGE.toString(),     new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.ORANGE_DYE,1)},ItemCore.item_syrup_orange,ItemCore.item_crashedice_orange,ItemCore.item_crashedice_milk_orange,ItemCore.item_sugar_water_orange,ItemCore.item_icecandy_orange,new ResourceLocation("drf:textures/entity/crashedice_orange.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_orange.png")),
		SYRUP_WHITE     (17,    DyeColor.WHITE.toString(),      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.WHITE_DYE,1)},ItemCore.item_syrup_white,ItemCore.item_crashedice_white,ItemCore.item_crashedice_milk_white,ItemCore.item_sugar_water_white,ItemCore.item_icecandy_white,new ResourceLocation("drf:textures/entity/crashedice_white.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_white.png")),
		SYRUP_APPLE     (18,    "apple",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.APPLE,1)},ItemCore.item_syrup_apple,ItemCore.item_crashedice_apple,ItemCore.item_crashedice_milk_apple,ItemCore.item_sugar_water_apple,ItemCore.item_icecandy_apple,new ResourceLocation("drf:textures/entity/crashedice_apple.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_apple.png")),
		SYRUP_CACTUS    (19,    "cactus",                       new EffectInstance[] {}, new ItemStack[]{new ItemStack(Blocks.CACTUS,1)},ItemCore.item_syrup_cactus,ItemCore.item_crashedice_cactus,ItemCore.item_crashedice_milk_cactus,ItemCore.item_sugar_water_cactus,ItemCore.item_icecandy_cactus,new ResourceLocation("drf:textures/entity/crashedice_cactus.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_cactus.png")),
		SYRUP_MELON     (20,    "melon",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.MELON_SLICE,1), new ItemStack(Blocks.MELON,1)},ItemCore.item_syrup_melon,ItemCore.item_crashedice_melon,ItemCore.item_crashedice_milk_melon,ItemCore.item_sugar_water_melon,ItemCore.item_icecandy_melon,new ResourceLocation("drf:textures/entity/crashedice_mellon.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_mellon.png")),
		SYRUP_PUMPKIN   (21,    "pumpkin",                      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Blocks.PUMPKIN,1)},ItemCore.item_syrup_pumpkin,ItemCore.item_crashedice_pumpkin,ItemCore.item_crashedice_milk_pumpkin,ItemCore.item_sugar_water_pumpkin,ItemCore.item_icecandy_pumpkin,new ResourceLocation("drf:textures/entity/crashedice_pumpkin.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_pumpkin.png")),
		SYRUP_GREENTEA  (22,    "greentea",                     new EffectInstance[] {}, new ItemStack[]{new ItemStack(ItemCore.item_greendust,1)},ItemCore.item_syrup_greentea,ItemCore.item_crashedice_greentea,ItemCore.item_crashedice_milk_greentea,ItemCore.item_sugar_water_greentea,ItemCore.item_icecandy_greentea,new ResourceLocation("drf:textures/entity/crashedice_greentea.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_greentea.png")),
		SYRUP_INK_SAC   (23,    "inc_sac",                      new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.INK_SAC,1)},ItemCore.item_syrup_ink_sac,ItemCore.item_crashedice_ink_sac,ItemCore.item_crashedice_milk_ink_sac,ItemCore.item_sugar_water_ink_sac,ItemCore.item_icecandy_ink_sac,new ResourceLocation("drf:textures/entity/crashedice_ink_sac.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_ink_sac.png")),
		SYRUP_COCOA     (24,    "cocoa",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.COCOA_BEANS,1)},ItemCore.item_syrup_cocoa,ItemCore.item_crashedice_cocoa,ItemCore.item_crashedice_milk_cocoa,ItemCore.item_sugar_water_cocoa,ItemCore.item_icecandy_cocoa,new ResourceLocation("drf:textures/entity/crashedice_cocoa.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_cocoa.png")),
		SYRUP_BERRY     (25,    "berry",                        new EffectInstance[] {}, new ItemStack[]{new ItemStack(Items.SWEET_BERRIES,1)},ItemCore.item_syrup_berry,ItemCore.item_crashedice_berry,ItemCore.item_crashedice_milk_berry,ItemCore.item_sugar_water_berry,ItemCore.item_icecandy_berry,new ResourceLocation("drf:textures/entity/crashedice_berry.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_berry.png")),
		SYRUP_KELP      (26,    "kelp",                         new EffectInstance[] {new EffectInstance(Effects.WATER_BREATHING, 1200, 1)}, new ItemStack[]{new ItemStack(ItemCore.item_kelpdust,1)},ItemCore.item_syrup_kelp,ItemCore.item_crashedice_kelp,ItemCore.item_crashedice_milk_kelp,ItemCore.item_sugar_water_kelp,ItemCore.item_icecandy_kelp,new ResourceLocation("drf:textures/entity/crashedice_kelp.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_kelp.png")),
		SYRUP_GOLDAPPLE (27,    "goldapple",                    new EffectInstance[] {new EffectInstance(Effects.REGENERATION, 100, 1), new EffectInstance(Effects.ABSORPTION, 2400, 0)},new ItemStack[]{new ItemStack(Items.GOLDEN_APPLE,1)},ItemCore.item_syrup_goldapple,ItemCore.item_crashedice_goldenapple,ItemCore.item_crashedice_milk_goldapple,ItemCore.item_sugar_water_goldapple,ItemCore.item_icecandy_goldapple,new ResourceLocation("drf:textures/entity/crashedice_goldapple.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_goldapple.png")),
		SYRUP_GOLDAPPLEENC (28, "goldappleenc",                 new EffectInstance[] {new EffectInstance(Effects.REGENERATION, 400, 1), new EffectInstance(Effects.RESISTANCE, 6000, 0), new EffectInstance(Effects.FIRE_RESISTANCE, 6000, 0), new EffectInstance(Effects.ABSORPTION, 2400, 3)},new ItemStack[]{new ItemStack(Items.ENCHANTED_GOLDEN_APPLE,1)},ItemCore.item_syrup_goldappleenc,ItemCore.item_crashedice_goldappleenc,ItemCore.item_crashedice_milk_goldappleenc,ItemCore.item_sugar_water_goldappleenc,ItemCore.item_icecandy_goldappleenc,new ResourceLocation("drf:textures/entity/crashedice_goldappleenc.png"),new ResourceLocation("drf:textures/entity/crashedice_millk_goldappleenc.png"));
		...
		private ItemStack[] baseItem;
		private Item syrup;
		private Item crushice;
		private Item milkcrushice;
		private Item sugarwater;
		private Item icecandy;
		private ResourceLocation tex_crushice;
		private ResourceLocation tex_milkcrushice;

		private EnumFlapeSyrup(int idx,String name, EffectInstance[] effect, ItemStack[] item, Item item1, Item item2, Item item3, Item item4, Item item5, ResourceLocation tex1, ResourceLocation tex2){
			index = idx;
			damage = idx;
			flavor = name;
			effects = effect;
		...
		public Item getSyrup(){return syrup;}
		public Item getCrushIce(){return crushice;}
		public Item getMilkCrushIce(){return milkcrushice;}
		public Item getSugerWater(){return sugarwater;}
		public Item getIceCandy(){return icecandy;}
	...
	public static enum EnumFlowerHalb{
		...
		ORCHID(2,2,"orchid",new Effect[]{Effects.POISON},ItemCore.item_flowerdust_orchid, ItemCore.item_flowertea_orchid,false),
		...
		CORM(12,12,"corm",new Effect[]{Effects.POISON},ItemCore.item_flowerdust_corm, ItemCore.item_flowertea_corm,false),
		...
		CORAL(14,14,"coral", new Effect[] {Effects.WATER_BREATHING},ItemCore.item_flowerdust_coral, ItemCore.item_flowerdust_coral,false);
		...
		private EnumFlowerHalb(int idx, int dmg, String flv, Effect[] effect, Item item1, Item item2, boolean clean){
			this.index = idx;
			this.damage = dmg;
			this.flavor = flv;
			this.effect = effect;
