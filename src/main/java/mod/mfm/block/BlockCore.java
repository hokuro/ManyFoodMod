...
public class BlockCore{
	...
	public static Block block_cow_cooked = new BlockMeet(Items.COOKED_BEEF,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_COW_COOKED)));
	public static Block block_pig_cooked = new BlockMeet(Items.COOKED_PORKCHOP,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_PIG_COOKED)));
	public static Block block_chikin_cooked = new BlockMeet(Items.COOKED_CHICKEN,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_CHIKIN_COOKED)));
	public static Block block_mutton_cooked = new BlockMeet(Items.COOKED_MUTTON,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_MUTTON_COOKED)));
	public static Block block_rabitt_cooked = new BlockMeet(Items.COOKED_RABBIT,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_RABITT_COOKED)));
	public static Block block_zombie_cooked = new BlockMeet(ItemCore.cooked_rotten_flesh,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_ZOMBIE_COOKED)));
	public static Block block_fish_cooked = new BlockMeet(Items.COOKED_COD,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_FISH_FISH_COOKED)));
	public static Block block_salmon_cooked = new BlockMeet(Items.COOKED_SALMON,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_FISH_SALMON_COOKED)));
	public static Block block_clown_cooked = new BlockMeet(ItemCore.cooked_clown,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_FISH_CLOWN_COOKED)));
	public static Block block_puffer_cooked = new BlockMeet(ItemCore.cooked_puffer,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_FISH_PUFFER_COOKED)));
	public static Block block_meetwolf_cooked = new BlockMeet(ItemCore.cooked_wolf,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_WOLF_COOKED)));
	public static Block block_meetcat_cooked = new BlockMeet(ItemCore.cooked_cat,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_CAT_COOKED)));
	public static Block block_meethorse_cooked = new BlockMeet(ItemCore.cooked_horse,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_HORSE_COOKED)));
	public static Block block_meetbear_cooked = new BlockMeet(ItemCore.cooked_bear,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_BEAR_COOKED)));
	public static Block block_meetllamas_cooked = new BlockMeet(ItemCore.cooked_llamas,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_LLAMAS_COOKED)));
	public static Block block_meetfox_cooked = new BlockMeet(ItemCore.cooked_fox,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_FOX_COOKED)));
	public static Block block_meetdolphin_cooked = new BlockMeet(ItemCore.cooked_dolphin,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_DOLPHIN_COOKED)));
	public static Block block_meetflesh_cooked = new BlockMeet(ItemCore.cooked_flesh,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_MEET_FLESH_COOKED)));
	public static Block block_fishturtle_cooked = new BlockMeet(ItemCore.cooked_turtle,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_FIHS_TURTLE_COOKED)));
	public static Block block_fishsquid_cooked = new BlockMeet(ItemCore.cooked_squid,true).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+ NAME_FISH_SQUID_COOKED)));
	public static Block block_cow = new BlockMeet(Items.BEEF, false, block_cow_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_COW)));
	public static Block block_pig = new BlockMeet(Items.PORKCHOP,false,block_pig_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_PIG)));
	public static Block block_chikin = new BlockMeet(Items.CHICKEN, false,block_chikin_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_CHIKIN)));
	public static Block block_mutton = new BlockMeet(Items.MUTTON, false,block_mutton_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_MUTTON)));
	public static Block block_rabitt = new BlockMeet(Items.RABBIT, false,block_rabitt_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_RABITT)));
	public static Block block_zombie = new BlockMeet(Items.ROTTEN_FLESH, false,block_zombie_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_ZOMBIE)));
	public static Block block_fish = new BlockMeet(Items.COD,false,block_fish_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_FISH_FISH)));
	public static Block block_salmon = new BlockMeet(Items.SALMON, false,block_salmon_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_FISH_SALMON)));
	public static Block block_clown = new BlockMeet(Items.TROPICAL_FISH,false,block_clown_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_FISH_CLOWN)));
	public static Block block_puffer = new BlockMeet(Items.PUFFERFISH,false,block_puffer_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_FISH_PUFFER)));
	public static Block block_meetwolf = new BlockMeet(ItemCore.meet_wolf,false,block_meetwolf_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_WOLF)));
	public static Block block_meetcat = new BlockMeet(ItemCore.meet_cat,false,block_meetcat_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_CAT)));
	public static Block block_meethorse = new BlockMeet(ItemCore.meet_horse,false,block_meethorse_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_HORSE)));
	public static Block block_meetbear = new BlockMeet(ItemCore.meet_bear,false,block_meetbear_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_BEAR)));
	public static Block block_meetllamas = new BlockMeet(ItemCore.meet_llamas,false,block_meetllamas_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_LLAMAS)));
	public static Block block_meetfox = new BlockMeet(ItemCore.meet_fox,false,block_meetfox_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_FOX)));
	public static Block block_meetdolphin = new BlockMeet(ItemCore.meet_dolphin,false,block_meetdolphin_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_DOLPHIN)));
	public static Block block_meetflesh = new BlockMeet(ItemCore.raw_flesh,false,block_meetflesh_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_MEET_FLESH)));
	public static Block block_fishturtle = new BlockMeet(ItemCore.raw_turtle,false,block_fishturtle_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_FISH_TURTLE)));
	public static Block block_fishsquid = new BlockMeet(ItemCore.cooked_squid,false,block_fishsquid_cooked).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +new ResourceLocation(ModCommon.MOD_ID+":"+NAME_FISH_SQUID)));

	private static final int EffectLevel = 1;
	private static final int EffectTime = 1600;

	public static  Block block_cookingworkbench = new BlockCookingWorkBench(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.0F,0.98F).doesNotBlockMovement()).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +NAME_COOKINGWORKBENCH));
	public static  Block block_freezer          = new BlockFreezer(Block.Properties.create(Material.GLASS).sound(SoundType.METAL).hardnessAndResistance(1.0F,5.0F).doesNotBlockMovement()).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +NAME_FREEZER));
	public static  Block block_icecrasher       = new BlockIceCrasher(Block.Properties.create(Material.GLASS).sound(SoundType.METAL).hardnessAndResistance(1.0F,5.0F).doesNotBlockMovement()).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +NAME_ICECRASHER));
	public static  Block block_millstone        = new BlockMillStone(Block.Properties.create(Material.GLASS).sound(SoundType.STONE).hardnessAndResistance(1.0F,5.0F).doesNotBlockMovement()).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +NAME_MILLSTONE));
	public static  Block block_saltpan          = new BlockSaltPan(Block.Properties.create(Material.GLASS).sound(SoundType.WOOD).hardnessAndResistance(0.5F,0.1F).doesNotBlockMovement()).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +NAME_SALTPAN));
	...
	public static void init(){
		...
		itemMap = new HashMap<String,Item>(){
			...
			{put(NAME_GOLDAPPLEENC_PIE_HALL, (new ItemBlockPie(block_goldapplepie_hall,(new Item.Properties()).group(Mod_ManyFoods.tabPieCakes).maxStackSize(16))).setRegistryName(new ResourceLocation(ModCommon.MOD_ID + ":" +NAME_GOLDAPPLEENC_PIE_HALL)));}
