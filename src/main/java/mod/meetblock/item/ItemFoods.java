...
public class ItemFoods {
	...
	public static Food food_raw_bear = new Food.Builder().hunger(4).saturation(0.2F).effect(new EffectInstance(Effects.HUNGER,600,2),3.0F).meat().build();
	public static Food food_cooked_bear = new Food.Builder().hunger(4).saturation(0.3F).meat().build();
	public static Food food_raw_llamas = new Food.Builder().hunger(4).saturation(0.2F).effect(new EffectInstance(Effects.HUNGER,600,2),3.0F).meat().build();
	public static Food food_cooked_llamas = new Food.Builder().hunger(4).saturation(0.3F).meat().build();
	public static Food food_raw_fox = new Food.Builder().hunger(4).saturation(0.2F).effect(new EffectInstance(Effects.HUNGER,600,2),3.0F).meat().build();
	public static Food food_cooked_fox = new Food.Builder().hunger(4).saturation(0.3F).meat().build();
	public static Food food_raw_dolphin = new Food.Builder().hunger(4).saturation(0.2F).effect(new EffectInstance(Effects.HUNGER,600,2),3.0F).meat().build();
	public static Food food_cooked_dolphin = new Food.Builder().hunger(4).saturation(0.3F).meat().build();
	public static Food food_raw_turtle = new Food.Builder().hunger(4).saturation(0.2F).effect(new EffectInstance(Effects.HUNGER,600,2),3.0F).meat().build();
	public static Food food_cooked_turtle = new Food.Builder().hunger(4).saturation(0.3F).meat().build();
	public static Food food_raw_squid = new Food.Builder().hunger(2).saturation(0.1F).effect(new EffectInstance(Effects.POISON,600,2),3.0F).meat().build();
	public static Food food_cooked_squid = new Food.Builder().hunger(4).saturation(0.1F).meat().build();
	public static Food food_raw_flesh = new Food.Builder().hunger(1).saturation(0.1F).effect(new EffectInstance(Effects.NAUSEA,600,2),1.0F).meat().build();
	public static Food food_cooked_flesh = new Food.Builder().hunger(1).saturation(0.1F).effect(new EffectInstance(Effects.NAUSEA,600,2),1.0F).meat().build();
}
